...
# Only use Gateway API if cluster 1 has ambient enabled and Gateway API CRDs are available
# Cluster 1 has ambient if AMBIENT is true (cluster 2 ambient setting doesn't matter for cluster 1)
